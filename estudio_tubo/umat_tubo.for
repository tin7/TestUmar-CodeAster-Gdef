C===========================================================================
C UMAT elastica lineal para el caso del tubo con presion interna.
C Actualiza coordenadas de los puntos de Gauss via STATEV.
C
...
C---- Registro de coordenadas: primer GP (NPT=1) de cada elemento.
C     NOEL en Code_Aster es numeracion interna; no se filtra por NOEL
C     para garantizar output independientemente de la numeracion.
C     STATEV(1:3) = coords actuales, STATEV(4:6) = coords anteriores

      IF (NPT.EQ.1) THEN
         OPEN(UNIT=99,FILE='/work/umat_tubo.log',
